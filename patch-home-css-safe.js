...
// The regex matches everything from .eternum-home { until the Incomer exact component comment
const homeRegex = /\.eternum-home\s*\{[\s\S]*?\/\*\s*Incomer exact component reconstruction:/;
...
/* Incomer exact component reconstruction:`;

if (homeRegex.test(css)) {
  css = css.replace(homeRegex, newCSS);
