...
// Options — not generic radio cards. `options` is already the backend's
// final, affordability-filtered list (see payments.api.js's
// fetchCustomerPaymentOptions) — every option shown here is genuinely
// selectable, so there is no client-side disabled state to compute.
