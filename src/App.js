...
const StatusRow = ({ icon = "‚óá", label, value, note }) => (
...
function PublicWebsite() {
  ...
  /* ---- Global public loading screen ‚Äî blocks all public content ---- */
  if (showLoader) {
  ...
  if (page === "alreadyRegistered" || page === "trackLookup") {
    ...
    return (
      <div className="outcomer-landing-container arp-page">
        ...
        {/* APPLICATION NOT FOUND ‚Äî only after failed lookup */}
        {lookupFailed && (
          <>
      ...
      <div className="outcomer-landing-container outcomer-register-container">
        ...
        <div className="outcomer-reg-form">
          ...
          <div className={`outcomer-reg-card ${errors.gender ? "error" : ""}`}>
            ...
            <div className="outcomer-reg-input-group outcomer-reg-gender-group">
                ...
                >
                  <span className="outcomer-gender-radio">{request.gender === 'male' ? '‚óè' : '‚óã'}</span>
                  MALE
                </button>
                <button
                  type="button"
                ...
                >
                  <span className="outcomer-gender-radio">{request.gender === 'female' ? '‚óè' : '‚óã'}</span>
                  FEMALE
                </button>
              </div>
            </div>
        ...
        <div className="outcomer-reg-footer">
          ...
          <button className="outcomer-reg-submit" onClick={goToPayment} disabled={isSubmitting}>
            {isSubmitting ? "SUBMITTING..." : "SUBMIT APPLICATION"} <span className="outcomer-reg-submit-arrow">‚Üí</span>
          </button>
        </div>
      </div>
    );
      ...
      <div className="pay-page">
        ...
        <div className="pay-card pay-method-card">
          ...
          <div className="pay-instapay-logo">
            <span className="pay-insta-white">INSTA</span><span className="pay-insta-arrows">¬ª</span><span className="pay-insta-pay">PAY</span>
          </div>
  ...
  if (page === "ticket" && foundClient) {
    ...
    const guestPhone     = safeValue(foundClient.phone || foundClient.Phone || foundClient.phoneNumber, "‚Äî");
    ...
    const school         = safeValue(foundClient.schoolOrOriginProm || foundClient.university || foundClient.school || foundClient.School, "‚Äî");
    const preferredName  = safeValue(foundClient.instagramUsername || foundClient.preferredName || foundClient.nickname || guestName.split(" ")[0], "‚Äî");
        ...
        <div className="rules-list">
          <div className="rule-card">
            ...
            <div className="rule-content">
              <h3>ENTRY</h3>
              <p>ï Your QR code is personal. Sharing or transferring it ends your access.</p>
              <p>ï ALSHAYEB team may request a valid ID for verification</p>
            </div>
          </div>
          <div className="rule-card">
            ...
            <div className="rule-content">
              <h3>DOORS</h3>
              <p>ï Doors open at 9:00 PM and close at 10:00 PM.</p>
              <p>ï Arrive early. Great experiences don't wait for late arrivals.</p>
            </div>
          </div>
          <div className="rule-card">
            ...
            <div className="rule-content">
              <h3>RE-ENTRY</h3>
              <p>ï Re-entry is permitted only for guests wearing their official ALSHAYEB wristband.</p>
              <p>ï Lost, removed, or damaged wristbands will void re-entry access.</p>
            </div>
          </div>
          <div className="rule-card">
          ...
          <div className="rule-card">
            ...
            <div className="rule-content">
              <h3>SECURITY</h3>
              <p>ï All guests are subject to security screening before entry.</p>
              <p>ï Weapons, illegal items, laser devices, drones, professional cameras, and unauthorized recording equipment never make it inside.</p>
            </div>
          </div>
          <div className="rule-card">
            ...
            <div className="rule-content">
              <h3>ALCOHOL & DRUGS</h3>
              <p>ï Illegal drugs and prohibited substances have no place here.</p>
              <p>ï Alcohol is available only at events where ALSHAYEB officially permits it.</p>
            </div>
          </div>
          <div className="rule-card">
            ...
            <div className="rule-content">
              <h3>RESPECT</h3>
              <p>ï Respect isn't optional. It's the minimum requirement to stay.</p>
              <p>ï Harassment, unwanted physical contact, violence, discrimination, or disruptive behavior ends your experience immediately.</p>
            </div>
          </div>
          <div className="rule-card">
            ...
            <div className="rule-content">
              <h3>MEDIA</h3>
              <p>ï Some moments deserve to be remembered.</p>
              <p>ï By attending, you agree that photos and videos featuring you may be used by ALSHAYEB's media team</p>
            </div>
          </div>
          <div className="rule-card">
            ...
            <div className="rule-content">
              ...
              <p>ï ALSHAYEB reserves the right to refuse entry or remove any guest to protect the experience and the safety of others.</p>
            </div>
          </div>
        </div>
